    ...
    getData().then(function(data) {
        ...
        $.each(allArmor, function(key, armor) {
            ...
            <div class="mob__img-container">
                <img class="mob__img" src="../img/armor/${armor.name}.PNG" alt="${armor.nameRU}" srcset="" data-toggle="modal" data-target="#${armor.name}" style="cursor:pointer">
                    ...
                    <div class="modal-dialog modal-dialog-centered img-pop-up">
                        <div class="modal-content">
                            <div class="modal-body d-flex justify-content-center">
                                <img src="../img/armor/${armor.name}.PNG" class="w-100">
                            </div>
                        </div>
                    </div>
                </div>
