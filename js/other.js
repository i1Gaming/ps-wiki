...
function renderArmor() {
    getData().then(function(data) {
        var allArmor = sortByName(data.allOther);

        $.each(allArmor, function(key, armor) {

            var mobCartHTML = `<div class="mob">
            <div class="mob__title">
                <div class="mob__name js-armor__name">${armor.nameRU}</div>
            </div>
            <div class="mob__img-container">
                <img class="mob__img" src="../img/other/${armor.name}.PNG" alt="${armor.nameRU}" srcset="">
            </div>
            <div class="mob__location">
